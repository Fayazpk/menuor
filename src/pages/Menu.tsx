      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="text-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 rounded-full h-16 w-16 border-4 border-transparent border-t-black mx-auto animate-ping"></div>
          </div>
        ...
        <div className="relative py-8 px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            {restaurant.description && (
              <p className="text-lg md:text-xl opacity-95 mb-8 max-w-2xl mx-auto leading-relaxed">
                {restaurant.description}
              </p>
            )}
            ...
            {activeMenuSections.map((section: MenuSection, index: number) => {
              ...
              return (
                <div 
                  ...
                  className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 ease-in-out"
                >
                  <button
